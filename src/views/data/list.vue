        ...
        <el-table-column type="expand">
          <template slot-scope="props">
            <el-card class="box-card">
              <el-table :data="props.row.mavenTagInfos">
                <el-table-column prop="tag" label="入库版本号">
                </el-table-column>
                <el-table-column prop="lastCommitID" label="lastCommitID">
                </el-table-column>
              </el-table>
            </el-card>
          </template>
...
import { getInsertHub } from "@/api/data";
      ...
      getInsertHub()
        .then((res) => {
          ...
          res.data.forEach((item, idx) => {
            item.id = idx;
            this.maveninfo.num_ver += item.mavenTagInfos.length;
