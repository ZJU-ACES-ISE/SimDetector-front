  ...
  <div class="analysis-wrapper">
    <div class="module">
      ...
      >
          ...
          <template slot-scope="props">
            <el-card class="box-card">
              <el-table :data="props.row.children">
                ...
                <el-table-column prop="maxweightdis" label="代码总长">
                  <template slot-scope="scope">
                    {{ Number(scope.row.allCodeLength).toFixed(2) }}
                  </template>
                </el-table-column>
              </el-table>
            </el-card>
        ...
        <el-table-column prop="maxweightdis" label="二次验证/%">
          <template slot-scope="scope">
            {{ Number(scope.row.children[0].averate).toFixed(2) }}
          </template>
        </el-table-column>
        <el-table-column prop="maxweightdis" label="代码总长">
          <template slot-scope="scope">
            {{ Number(scope.row.children[0].allCodeLength) }}
          </template>
        </el-table-column>
...
import * as cover from "../../assets/json/temp1_filter.json";
export default {
  data() {
    return {
